...
# The AFINN lexicon is a list of English terms manually rated for valence 
# with an integer between -5 (negative) and +5 (positive) 
# by Finn Årup Nielsen from 2009 to 2011. To learm more: https://arxiv.org/abs/1103.2903
